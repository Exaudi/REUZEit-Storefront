...
jQuery( document ).ready( ( $ ) => {
	...
	window.WC_Cybersource_Payment_Form_Handler = window.SV_WC_Payment_Form_Handler_v5_7_1;
	 ...
	 * @since 2.0.0-dev-2
	 */
	window.WC_Cybersource_Flex_Payment_Form_Handler = class WC_Cybersource_Flex_Payment_Form_Handler extends SV_WC_Payment_Form_Handler_v5_7_1 {
